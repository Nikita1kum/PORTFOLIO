...
const Contact = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const serviceId = 'service_3y798zd'
        const templateId = 'template_akpnfcl'
        const publicKey = '8tRAcw5Rf6cHzLeVO'

        const templateParams = {
            from_name: name,
            to_name: 'Nikita Kumari',
            from_email: email,
            message: message,
        }
            ...
            <div className='max-w-7xl mx-auto'>
                <div className='text-center mb-6 mt-5'>
                    <h2 className='flex justify-center items-center mb-4 text-3xl md:text-4xl font-bold'>
                        <Mail style={{ width: "2rem", height: '2rem' }} className='mr-4' />
                        Get In Touch
                    </h2>
                    <p className='px-4 mb-4 text-slate-600 dark:text-slate-200/80 text-sm sm:text-lg md:text-xl'>
                        I’m always open to discussing opportunities, collaborating on projects, or just talking tech.
                    </p>
                </div>
                    ...
                    <div className='mx-5 text-center md:text-left'>
                        <div className='md:mx-5'>
                            ...
                            <p className='text-sm text-slate-600 dark:text-slate-200/80 leading-relaxed mb-8'>
                                Feel free to reach out for collaborations, queries, or discussions on cloud, DevOps, or AI projects.
                        ...
                        <div className='space-y-6'>
                            ...
                            <div className="group flex items-center space-x-4 p-6 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 border text-slate-600 dark:text-slate-200/80 text-left">
                                ...
                                <div>
                                    ...
                                    <p className="">kumarinikita7331@gmail.com</p>
                                    <p className="text-sm mt-1">Best way to reach me</p>
                                </div>
                            </div>
                            ...
                            <div className="group flex items-center space-x-4 p-6 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 border text-slate-600 dark:text-slate-200/80 text-left">
                                ...
                                <div>
                                    ...
                                    <p className="">+91 9693846420</p>
                                    <p className="text-sm mt-1">Available 9 AM - 7 PM IST</p>
                                </div>
                            </div>
                            ...
                            <div className="group flex items-center space-x-4 p-6 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 border text-slate-600 dark:text-slate-200/80 text-left">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm mt-1">Open to remote & on-site roles</p>
                                </div>
                            </div>
                        </div>
                    </div>
